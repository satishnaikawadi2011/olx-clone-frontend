				...
				<div className="main-content">
					<div className="left box">
						...
						<div className="content">
							<p>
								'Meri Dukan ' is a very popular online platform to sell and buy various shopping items
								on great discount deals. It is very trustworthy platform and it has various online
								services to give better user experience
							</p>
